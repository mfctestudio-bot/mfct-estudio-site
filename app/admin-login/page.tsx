        ...
        <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 8, padding: '2rem' }}>
          <form onSubmit={entrar}>
            ...
            <input type="text" value={usuario} onChange={e => setUsuario(e.target.value)}
              ...
              style={{ width: '100%', background: 'var(--bg2)', border: `1px solid ${erro ? 'var(--danger)' : 'var(--border)'}`, borderRadius: 6, padding: '12px 14px', color: 'var(--text)', fontSize: 16, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box', marginBottom: 12 }} />
